...
class BrandsApiController extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        if ($brandMode === 'global') {
            $brand->background_color_for_light_theme = \App\Models\Setting::get_value('brand_background_color_light_theme') ?: '';
            $brand->background_color_for_dark_theme = \App\Models\Setting::get_value('brand_background_color_dark_theme') ?: '';
        } else {
            $brand->background_color_for_light_theme = $request->background_color_for_light_theme ?? (\App\Models\Setting::get_value('brand_background_color_light_theme') ?: '');
            $brand->background_color_for_dark_theme = $request->background_color_for_dark_theme ?? (\App\Models\Setting::get_value('brand_background_color_dark_theme') ?: '');
        }
        $brand->save();
    ...
    public function update(Request $request)
    {
        ...
        if ($isDefaultLang) {
            ...
            if ($brandMode === 'global') {
                ...
                $brand->background_color_for_light_theme = $request->background_color_for_light_theme ?? $brand->background_color_for_light_theme;
                $brand->background_color_for_dark_theme = $request->background_color_for_dark_theme ?? $brand->background_color_for_dark_theme;
            }
