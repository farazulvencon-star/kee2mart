...
class CountryApiController extends Controller
{
    ...
    public function save(Request $request)
    {
        ...
        if ($countryMode === 'global') {
            $country->background_color_for_light_theme = \App\Models\Setting::get_value('country_background_color_light_theme') ?: '';
            $country->background_color_for_dark_theme = \App\Models\Setting::get_value('country_background_color_dark_theme') ?: '';
        } else {
            $country->background_color_for_light_theme = $request->background_color_for_light_theme ?? (\App\Models\Setting::get_value('country_background_color_light_theme') ?: '');
            $country->background_color_for_dark_theme = $request->background_color_for_dark_theme ?? (\App\Models\Setting::get_value('country_background_color_dark_theme') ?: '');
        }
    ...
    public function update(Request $request)
    {
        ...
        if ($countryMode === 'global') {
            ...
            $country->background_color_for_light_theme = $request->background_color_for_light_theme ?? $country->background_color_for_light_theme;
            $country->background_color_for_dark_theme = $request->background_color_for_dark_theme ?? $country->background_color_for_dark_theme;
        }
