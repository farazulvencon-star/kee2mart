    ...
    public function save(Request $request)
    {
        ...
        if (!$category) {
            ...
            if ($categoryMode === 'global') {
                $category->background_color_for_light_theme = \App\Models\Setting::get_value('category_background_color_light_theme') ?: '';
                $category->background_color_for_dark_theme = \App\Models\Setting::get_value('category_background_color_dark_theme') ?: '';
            } else {
                $category->background_color_for_light_theme = $request->background_color_for_light_theme ?? (\App\Models\Setting::get_value('category_background_color_light_theme') ?: '');
                $category->background_color_for_dark_theme = $request->background_color_for_dark_theme ?? (\App\Models\Setting::get_value('category_background_color_dark_theme') ?: '');
            }
    ...
    public function update(Request $request)
    {
        ...
        if ($isDefaultLanguage) {
            ...
            if ($categoryMode === 'global') {
                ...
                $category->background_color_for_light_theme = $request->background_color_for_light_theme ?? $category->background_color_for_light_theme;
                $category->background_color_for_dark_theme = $request->background_color_for_dark_theme ?? $category->background_color_for_dark_theme;
            }
        }
