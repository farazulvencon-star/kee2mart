...
class ReturnRequestsApiController extends Controller
{
    public function index()
    {
        ...
        $query = ReturnRequest::select(
            ...
            ->when(request()->header('X-Module-Id'), function ($q, $moduleId) {
                $q->where('products.module_id', $moduleId);
            })
    ...
    public function sellerIndex(Request $request)
    {
        ...
        try {
            ...
            // Apply module filter
            $moduleId = request()->header('X-Module-Id');
            if ($moduleId) {
                $query->where('products.module_id', $moduleId);
            }
