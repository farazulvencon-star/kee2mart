...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      products: [],
      category: "",
      seller: _Auth_js__WEBPACK_IMPORTED_MODULE_1__["default"].user && _Auth_js__WEBPACK_IMPORTED_MODULE_1__["default"].user.role && _Auth_js__WEBPACK_IMPORTED_MODULE_1__["default"].user.role.name === "Seller" && _Auth_js__WEBPACK_IMPORTED_MODULE_1__["default"].user.seller !== null ? _Auth_js__WEBPACK_IMPORTED_MODULE_1__["default"].user.seller.id : "",
      is_approved: "",
      selectedItems: [],
      select: '',
      all_select: false,
                ...
                _c(
                  ...
                  [
                    ...
                    _c(
                      ...
                      {
                        staticClass:
                          "d-flex gap-2 align-items-center flex-wrap flex-shrink-0",
                      },
                      [
                        _c(
                          "button",
                        ...
                        _c(
                          ...
                          [
                            ...
                            _vm._v(" "),
                            _c("span", [_vm._v(_vm._s(_vm.__("bulk_delete")))]),
                          ],
                          1
                        ),
                        _vm._v(" "),
                        ...
                        _c(
                          "b-dropdown",
                          {
                            ...
                            attrs: {
                              ...
                              "no-caret": "",
                              "toggle-class":
                                "btn-figma-columns d-flex align-items-center gap-2",
                                  ...
                                  change: [
                                    function ($event) {
                                      var $$a = _vm.selectedItems,
                                        ...
                                        $$c = $$el.checked ? true : false
                                      if (Array.isArray($$a)) {
                                        var $$v = row.item.product_variant_id,
                                          $$i = _vm._i($$a, $$v)
                                        if ($$el.checked) {
                                          $$i < 0 &&
