...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    translatedDeliveryBoys: function translatedDeliveryBoys() {
      ...
      return this.deliveryBoys.map(function (boy) {
        var translatedBoy = _objectSpread({}, boy);
        if (boy.translations && Array.isArray(boy.translations)) {
          var translation = boy.translations.find(function (t) {
  ...
  methods: {
      ...
      return axios.get(this.$apiUrl + '/active_languages').then(function (response) {
        if (Array.isArray(response.data.data)) {
          ...
          if (currentLanguage) {
            ...
            var defaultLang = _this3.activeLanguages.find(function (lang) {
    ...
    getDeliveryBoys: function getDeliveryBoys() {
      ...
      axios.get(this.$apiUrl + '/delivery_boys', {
        ...
        _this4.deliveryBoys = response.data.data.filter(function (boy) {
          return boy.status !== 0;
        }) || [];
    ...
    deleteDeliveryBoys: function deleteDeliveryBoys(index, id) {
      ...
      this.$swal.fire({
        ...
        if (result.value) {
          ...
          axios.post(_this5.$apiUrl + '/delivery_boys/delete', postData).then(function (response) {
            _this5.isLoading = false;
            _this5.deliveryBoys.splice(index, 1);
                      ...
                      _vm.$can("delivery_boy_create")
                        ? _c(
                            "router-link",
                            {
                              staticClass:
                                "btn btn-figma-filter d-flex align-items-center gap-2",
                              attrs: { to: "/delivery_boys/create" },
                            },
                            [
                              _c("i", { staticClass: "fa fa-plus" }),
                              _vm._v(" "),
                              _c("span", [
                                _vm._v(_vm._s(_vm.__("add_delivery_boy"))),
                              ]),
                            ]
                          )
                        : _vm._e(),
                        ...
                        fn: function (row) {
                          return [
                            row.item.status == 0
                              ...
                              : row.item.status == 4
                              ? _c("label", { staticClass: "badge bg-black" }, [
                                  _vm._v(_vm._s(_vm.__("blocked"))),
                                ])
                              : row.item.status == 7
                              ? _c(
