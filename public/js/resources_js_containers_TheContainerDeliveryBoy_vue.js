...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    checkDeliveryBoyStatus: function checkDeliveryBoyStatus() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_4___default().post(this.$apiUrl + '/delivery_boy/get_delivery_boy_status').then(function (response) {
    ...
    getStats: function getStats() {
      var _this5 = this;
      axios__WEBPACK_IMPORTED_MODULE_4___default().get(this.$deliveryBoyApiUrl + '/dashboard').then(function (response) {
        if (response.data.status === 1) {
          _this5.stats = response.data.data;
        }
      })["catch"](function (error) {
