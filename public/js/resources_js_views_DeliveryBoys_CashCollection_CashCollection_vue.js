...
/* harmony import */ var _Edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Edit */ "./resources/js/views/DeliveryBoys/CashCollection/Edit.vue");
  ...
  methods: {
    ...
    getTransactions: function getTransactions() {
      ...
      axios.get(this.$apiUrl + '/cash_collection', {
        ...
        _this4.totalRows = _this4.transactions.length;
            ...
            _c("div", { staticClass: "form-group" }, [
              ...
              _c("input", {
                ...
                attrs: {
                  ...
                  id: "transaction_date",
                  required: "",
                  placeholder: _vm.__("select_date_and_time"),
                },
