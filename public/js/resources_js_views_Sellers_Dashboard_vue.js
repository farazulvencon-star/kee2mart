...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    categoryChartDataFormatted: function categoryChartDataFormatted() {
      var _this = this;
      return this.options2.labels.map(function (label, index) {
        return {
          name: label,
          value: _this.series2[index] || 0,
          color: _this.categoryChartColors[index % _this.categoryChartColors.length] || '#000'
        };
      });
    },
    orderStatusItems: function orderStatusItems() {
      var statusOrderCount = this.record && this.record.status_order_count ? this.record.status_order_count : [];
      if (!statusOrderCount.length) return [];
      var allowedStatuses = ['Payment Pending', 'Pending', 'Received', 'Processed', 'Shipped', 'Out For Delivery', 'Delivered'];
      var filtered = statusOrderCount.filter(function (s) {
        return allowedStatuses.includes(s.status);
      });
      var maxCount = Math.max.apply(Math, _toConsumableArray(filtered.map(function (s) {
      ...
      var statusMap = {
        'Payment Pending': {
          color: '#F59E0B',
          bgColor: '#FEF3C7',
          label: this.__('payment_pending') || 'Payment Pending'
        },
        'Pending': {
          color: '#F59E0B',
          bgColor: '#FEF3C7',
  ...
  created: function created() {
    ...
    var totalSaleText = this.__('total_sale') || 'Total Sale';
    var noDataFoundText = this.__('no_data_found') || 'No Data Found';
    this.options.noData.text = noDataFoundText;
    this.series[0].name = totalSaleText;
    this.options.tooltip.custom = function (_ref2) {
      ...
      var cat = w.globals.categoryLabels[dataPointIndex] || w.config.xaxis.categories[dataPointIndex];
      var sale = series[0] ? series[0][dataPointIndex] : 0;
      return '<div style="background:#111827;color:#fff;padding:12px;border-radius:12px;font-size:13px;line-height:1.6;border:none;box-shadow:0 10px 15px -3px rgba(0,0,0,0.1)">' + '<div style="margin-bottom:4px;font-weight:700">' + cat + '</div>' + '<div style="display:flex;align-items:center;gap:8px"><span style="width:8px;height:8px;border-radius:50%;background:#68E4A1"></span> ' + totalSaleText + ' : <span style="font-weight:700">' + (sale || 0).toLocaleString() + '</span></div>' + '</div>';
    };
    this.getRecord();
    this.getOrderStatus();
  ...
  methods: {
    ...
    getStatusLabel: function getStatusLabel(status) {
      if (!status) return '';
      var key = this.getStatusTranslationKey(status.id);
     ...
     */
    getCategoryDisplayName: function getCategoryDisplayName(name) {
      if (name == null) return '';
    ...
    getRecord: function getRecord() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(this.$sellerApiUrl + '/dashboard').then(function (res) {
        ...
        if (data.status === 1) {
          ...
          var totalColorsNeeded = _this2.options2.labels.length;
          var colorsArray = [];
          for (var i = 0; i < totalColorsNeeded; i++) {
            colorsArray.push(_this2.categoryChartColors[i % _this2.categoryChartColors.length]);
          }
          _this2.options2.colors = colorsArray;
          // pieChart
    ...
    getStatusIconBgClass: function getStatusIconBgClass(status) {
      ...
      _c("section", { staticClass: "row" }, [
        _c("div", { staticClass: "col-12 px-0" }, [
          _c(
            ...
            {
              staticClass:
                "row g-4 mb-4 row-cols-1 row-cols-sm-2 row-cols-md-4",
            },
            [
              _c(
                "div",
                  ...
                  _c(
                    ...
                    [
                      _c(
                        ...
                        {
                          staticClass:
                            "card border rounded-4 figma-card-white p-4 mb-0",
                        },
                        [
                          _c(
                            "div",
                            ...
                            [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "figma-stat-icon-box bg-stat-blue",
                                },
                                [
                                  _c("i", {
                                    staticClass:
                              ...
                              _c("div", { staticClass: "d-flex flex-column" }, [
                                _c(
                                  ...
                                  {
                                    staticClass:
                                      "figma-stat-label mb-1 text-capitalize",
                                  },
                                ...
                                _c(
                                  "h4",
                                  { staticClass: "figma-stat-value h1 mb-0" },
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "figma-stat-icon-box bg-stat-orange",
                                },
                                [
                                  _c("i", {
                                    staticClass: "fa fa-cubes text-white",
                                  }),
                                ]
                              ),
                              _vm._v(" "),
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "figma-stat-icon-box bg-stat-purple",
                                },
                                [
                                  _c("i", {
                                    staticClass: "fa fa-bullseye text-white",
                                  }),
                                ]
                              ),
                              _vm._v(" "),
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "figma-stat-icon-box bg-stat-green",
                                },
                                [
                                  _c("i", {
                                    staticClass: "fa fa-money text-white",
                                  }),
                                ]
                              ),
                              _vm._v(" "),
                              _c("div", { staticClass: "d-flex flex-column" }, [
                                ...
                                _c(
                                  ...
                                  [
                                    _vm._v(
                                      _vm._s(
                                        _vm.$currency + " " + _vm.record.balance
                                      )
                                    ),
                                  ]
                                ),
          ...
          _c("div", { staticClass: "row g-4 mb-4" }, [
            _c("div", { staticClass: "col-12" }, [
              _c(
                "div",
                {
                  staticClass: "card border figma-card overflow-hidden",
                  staticStyle: { "border-radius": "24px !important" },
                },
                [
                  _c(
                    "div",
                    ...
                    [
                      _c("div", { staticClass: "d-flex flex-column" }, [
                        _c(
                          "h4",
                          { staticClass: "h6 font-weight-bold text-dark mb-1" },
          ...
          _c("div", { staticClass: "row g-4 mb-4" }, [
            _c(
              "div",
              { staticClass: "col-12 col-lg-7 product_category_count" },
              [
                _c(
                  "div",
                  ...
                  [
                      ...
                      [
                        _c(
                          ...
                          [
                            _vm._v(
                              "\n                                " +
                                _vm._s(_vm.__("product_category_count")) +
                                "\n                                "
                            ),
                            _vm.options2.labels.length
                              ? _c(
                                  "span",
                                  {
                                    staticClass:
                                      "text-muted small font-weight-normal ms-1",
                                  },
                                  [
                                    _vm._v(
                                      "(" +
                                        _vm._s(_vm.options2.labels.length) +
                                        " " +
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "card-body p-4 pt-0" }, [
                      _vm.series2.length > 0
                        ? _c(
                            "div",
                            {
                        ...
                        : _c(
                            ...
                            [_vm._v(_vm._s(_vm.__("no_product_found")))]
                          ),
                    ]),
                  ]
                ),
                  ...
                  _c(
                    ...
                    [
                      _c(
                        "h4",
                        { staticClass: "h6 font-weight-bold text-dark mb-0" },
                        [_vm._v(_vm._s(_vm.__("order_out_lines")))]
                      ),
                    ]
                  ),
                  _vm._v(" "),
                              ...
                              [
                                ...
                                _c("div", { staticClass: "flex-grow-1" }, [
                                  _c(
                                    ...
                                    [
                                      ...
                                      _c(
                                        ...
                                        {
                                          staticClass:
                                            "small font-weight-bold text-dark mb-0",
                                        },
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c("div", {
                                        staticClass: "h-100 rounded-pill",
                                        style: {
                                          width: item.percent + "%",
                                          backgroundColor: item.color,
                                        },
          ...
          _c(
            ...
            {
              staticClass:
                "row g-4 mb-4 row-cols-1 row-cols-sm-2 row-cols-lg-4",
            },
            [
              _c(
                "div",
                  ...
                  _c(
                    ...
                    [
                      _c(
                        ...
                        {
                          staticClass:
                            "card border rounded-4 figma-card-white p-4 mb-0 h-100",
                        },
                        [
                          _c(
                            "div",
                            ...
                            [
                              _c(
                                ...
                                [
                                  _c("i", {
                                    staticClass: "fa fa-archive text-white",
                                  }),
                                ]
                              ),
                              _vm._v(" "),
                            ...
                            [
                              _c(
                                ...
                                [
                                  _c("i", {
                                    staticClass:
                                      "fa fa-balance-scale text-white",
                                  }),
                                ]
                              ),
                              _vm._v(" "),
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                {
                                  staticClass:
                                    "figma-stat-icon-box bg-stat-red",
                                },
                                [
                                  _c("i", {
                          ...
                          _c(
                            ...
                            [
                              _c(
                                ...
                                [
                                  _c("i", {
                                    staticClass: "fa fa-warning text-white",
                                  }),
                                ]
                              ),
                              _vm._v(" "),
          ...
          _c("div", { staticClass: "card figma-card text-dark mt-4" }, [
            _c("div", { staticClass: "card-header" }, [
              _c("h4", { staticClass: "text-dark" }, [
                _vm._v(_vm._s(_vm.__("latest_orders") || "Latest Orders")),
              ]),
              _vm._v(" "),
              _c(
                "div",
            ...
            _c("div", { staticClass: "card-body p-0" }, [
              _c(
                ...
                [
                  _c("b-table", {
                    staticClass: "figma-order-table text-dark mb-0",
                    attrs: {
                      items: _vm.orders,
              ...
              _vm._v(" "),
              _vm.orderTotalRows > 0
                ? _c(
                    "div",
                    {
                      staticClass:
                        "d-flex justify-content-between align-items-center px-4 pb-4 border-top pt-3 bg-light-soft rounded-bottom-4",
                    },
                    [
