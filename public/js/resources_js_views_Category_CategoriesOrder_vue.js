...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    ...
    this.$eventBus.$on('categorySaved', function () {
  ...
  methods: {
    ...
    getCategories: function getCategories() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/categories/row_order').then(function (response) {
        ...
        _this6.list = data.data.map(function (category, index) {
          return {
            id: category.id,
            name: category.name,
          ...
          _c(
            ...
            [
              _c("h4", { staticClass: "card-title mb-4" }, [
                _vm._v(_vm._s(_vm.__("main_categories_order_list"))),
              ]),
              _vm._v(" "),
              _c(
                "b-row",
                ...
                [
                  _c("b-col", { attrs: { md: "12" } }, [
                    _c("div", { staticClass: "form-check form-switch mb-0" }, [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                        ...
                        attrs: { type: "checkbox", id: "enableDragDrop" },
                        domProps: {
                                  ...
                                  _c(
                                    ...
                                    [
                                      _c(
                                        ...
                                        {
                                          staticClass:
                                            "text-muted mr-3 d-inline-block",
                                      ...
                                      category.all_parents
                                        ? _c(
                                            ...
                                            {
                                              staticClass:
                                                "d-flex align-items-center ml-4 all_parents",
                                            },
                                            _vm._l(
                                              _vm.getParentsList(
                                                category.all_parents
                                              ...
                                              function (parent, index) {
                                                return _c(
                                                  ...
                                                  [
                                                    _c("i", {
                                                      staticClass:
                                                        "fas fa-angle-left mr-2 text-muted",
                                                    }),
                                                    _vm._v(" "),
                                                    _c("img", {
                                                      staticClass:
