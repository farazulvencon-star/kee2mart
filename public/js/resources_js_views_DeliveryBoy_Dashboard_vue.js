  ...
  computed: {
    ...
    summaryStats: function summaryStats() {
      return [{
        ...
        value: this.record.order_count,
        url: '/delivery_boy/orders',
        icon: 'Total order',
        isSvg: true,
        bgClass: 'bg-stat-blue'
      }, {
        label: this.__('return_requests') || 'Returns',
        value: this.record.return_requests || 0,
        ...
        value: this.$currency + " " + this.record.balance,
        url: null,
        icon: 'total rev',
        isSvg: true,
  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "page-content" }, [
      _c("section", { staticClass: "row" }, [
        _c(
          "div",
          { staticClass: "row g-3 px-2 mb-4 row-cols-1 row-cols-sm-3" },
          _vm._l(_vm.summaryStats, function (stat, index) {
            return _c("div", { key: index, staticClass: "col" }, [
              _c(
                ...
                {
                  staticClass:
                    "card border rounded-4 figma-card-white p-3 mb-0",
                },
                [
                  _c(
                    stat.url ? "router-link" : "div",
                    {
                      tag: "component",
                      staticClass: "text-decoration-none d-block w-100",
                      attrs: { to: stat.url },
                    },
                    [
                      _c(
                        ...
                        [
                          ...
                          _c(
                            ...
                            {
                              staticClass:
                                "d-flex flex-column overflow-hidden w-100 text-start",
                            },
                            [
                              _c(
                                "span",
                                {
                                  staticClass:
                                    "figma-stat-label mb-1 text-truncate text-start w-100",
                                },
                              ...
                              _c(
                                ...
                                {
                                  staticClass:
                                    "figma-stat-value h1 mb-0 text-dark font-weight-bold text-start w-100",
                                },
        ...
        _c("div", { staticClass: "row mt-4" }, [
          _c("div", { staticClass: "col-12" }, [
            _c("div", { staticClass: "card figma-card" }, [
              _c(
                "div",
                {
                  staticClass:
                      ...
                      _c(
                        ...
                        [
                          _c(
                            ...
                            [
                              _vm._v(
                                _vm._s(_vm.__("view_orders") || "View Orders")
                              ),
                            ]
                          ),
                          _vm._v(" "),
                ...
                [
                  _c(
                    ...
                    [
                      _c("b-table", {
                        staticClass:
                          "table figma-table figma-order-table text-dark",
                        attrs: {
                          items: _vm.orders,
                            ...
                            fn: function (row) {
                              return [
                                _c(
                                  ...
                                  {
                                    staticClass:
                                      "text-primary font-weight-bold small",
                                  },
                          ...
                          },
                          {
                            ...
                            fn: function (row) {
                              return [
                                _c(
                                  "span",
                                  { staticClass: "figma-payment-method-badge" },
                  ...
                  _c(
                    "b-row",
                    { staticClass: "mt-3 px-3 pb-3" },
                    [
                      _c(
                        "b-col",
                        {
                          staticClass: "my-1 d-flex align-items-center",
                          attrs: { md: "6" },
                        },
                        [
                          _c(
                            ...
                            [
                              ...
                              _c("span", { staticClass: "showing-bold" }, [
                                _vm._v(
                                  _vm._s(
                                    Math.min(
                                      _vm.orderCurrentPage * _vm.orderPerPage,
                                      _vm.orderTotalRows
                                    )
                                  )
                                ),
