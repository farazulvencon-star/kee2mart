...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    module_id: function module_id(newVal) {
      if (newVal) {
  ...
  methods: {
    getModules: function getModules() {
      var _this = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(this.$apiUrl + '/modules').then(function (response) {
    ...
    getCategories: function getCategories() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(this.$sellerApiUrl + '/categories', {
        headers: headers
    ...
    [
      _c("div", { staticClass: "login-wrapper" }, [
        _c("div", { staticClass: "detail-card" }, [
          ...
          _vm._v(" "),
          _c("h4", [_vm._v(_vm._s(_vm.__("seller_complete_profile")))]),
          _vm._v(" "),
          _c("p", { staticClass: "auth-subtitle text-primary" }, [
            _vm._v(
              _vm._s(
                _vm.__("please_complete_the_form_to_complete_your_registration")
              )
            ),
          ]),
          _vm._v(" "),
            ...
            [
              _c("div", { staticClass: "row" }, [
                  ...
                  _c("div", { staticClass: "card-body" }, [
                    _c("div", { staticClass: "row g-4" }, [
                      ...
                      _c("div", { staticClass: "col-md-6" }, [
                        _c("div", { staticClass: "form-group mb-0" }, [
                          ...
                          _vm.mobilevalidationError
                            ? _c(
                                "span",
                                { staticClass: "error small text-danger" },
                      ...
                      _c("div", { staticClass: "col-md-6" }, [
                        _c("div", { staticClass: "form-group mb-0" }, [
                          _c("label", { staticClass: "form-label" }, [
                            _vm._v(_vm._s(_vm.__("select_module")) + " "),
                            _c("i", { staticClass: "text-danger" }, [
                              _vm._v("*"),
                            ]),
                          ]),
                          ...
                          _c(
                            "select",
                            {
                              ...
                              staticClass: "form-control form-select py-2",
                              attrs: { required: "" },
                              on: {
                                change: function ($event) {
                                  ...
                                  _vm.module_id = $event.target.multiple
                                    ? $$selectedVal
                                    : $$selectedVal[0]
                                },
                              },
                            ...
                            [
                              ...
                              _vm._l(_vm.modules, function (mod) {
                                return _c(
                                  "option",
                                  { key: mod.id, domProps: { value: mod.id } },
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "col-md-6 categories-field" }, [
                        _c(
                          "div",
                    ...
                    _vm._v(" "),
                    _c("div", { staticClass: "row g-4 mt-1" }, [
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c("multiselect", {
                              attrs: {
                                options: _vm.cities,
                                placeholder: _vm.__("select_and_search_city"),
                                label: "name",
                                "track-by": "name",
                                id: "city_name",
                                required: "",
                ...
                _c(
                  ...
                  {
                    staticClass:
                      "btn btn-primary btn-block btn-lg figma-btn-standard mt-4 py-3",
                  },
                  [
                    _vm._v(
                      "\n                        " +
