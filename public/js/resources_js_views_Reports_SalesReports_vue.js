  ...
  data: function data() {
    return {
      ...
      fields: [{
        ...
        key: 'sub_total',
        label: __('revenue') + ' (' + this.$currency + ')',
        sortable: true,
        "class": 'text-center'
      }, {
        key: 'cost_price',
        label: __('cost_price') + ' (' + this.$currency + ')',
        sortable: true,
        "class": 'text-center'
      }, {
        key: 'cost_total',
        label: __('cost_total') + ' (' + this.$currency + ')',
        sortable: true,
        "class": 'text-center'
      }, {
        key: 'margin_amount',
        label: __('margin_amount') + ' (' + this.$currency + ')',
        sortable: true,
        "class": 'text-center'
      }, {
        key: 'margin_pct',
  ...
  methods: {
    getSalesReports: function getSalesReports() {
      ...
      axios.get(this.$apiUrl + '/sales_reports', {
        ...
        _this.total_revenue = response.data.data.total_revenue || 0;
        _this.total_cost = response.data.data.total_cost || 0;
        _this.total_margin = response.data.data.total_margin || 0;
        _this.overall_margin_pct = response.data.data.overall_margin_pct || 0;
        ...
        _c("div", { staticClass: "figma-main-section-card" }, [
          _c(
            ...
            [
                        ...
                        _c("div", { staticClass: "figma-filter-group" }, [
                          ...
                          _c(
                            ...
                            [
                              ...
                              _vm._v(" "),
                              _vm._l(_vm.deliveryBoys, function (d) {
                                return _c(
                                  "option",
                                  { domProps: { value: d.id } },
                              ...
                              [
                                _vm._v(
                                  "\n                                    " +
                                    ...
                                    " " +
                                    _vm._s(
                                      Number(row.item.margin_amount).toFixed(2)
                                    ) +
                                    "\n                                "
                                ),
                              ]
                          ...
                          return [
                            _vm._v(
                              "\n                                " +
                                _vm._s(_vm.$currency) +
                                " " +
                                _vm._s(Number(row.item.cost_price).toFixed(2)) +
                                "\n                            "
                            ),
                          ]
                        },
                          ...
                          return [
                            _vm._v(
                              "\n                                " +
                                _vm._s(_vm.$currency) +
                                " " +
                                _vm._s(Number(row.item.cost_total).toFixed(2)) +
                                "\n                            "
                            ),
                          ]
                        },
              ...
              _vm._v(" "),
              _vm.salesReports.length > 0
                ? _c("div", { staticClass: "row g-3 my-3" }, [
                    _c("div", { staticClass: "col-6 col-md-3" }, [
                      _c(
                        "div",
                        {
                          staticClass:
                            "p-3 rounded border text-center bg-light",
                        },
                        [
                          _c("div", { staticClass: "text-muted small mb-1" }, [
                            _vm._v(_vm._s(_vm.__("total_revenue"))),
                          ]),
                          _vm._v(" "),
                          _c(
                            "div",
                            { staticClass: "h6 mb-0 text-primary fw-bold" },
                            [
                              _vm._v(
                                _vm._s(_vm.$currency) +
                                  " " +
                                  _vm._s(_vm.total_revenue.toFixed(2))
                              ),
                            ]
                          ),
                        ]
                    ...
                    _c("div", { staticClass: "col-6 col-md-3" }, [
                      _c(
                        ...
                        [
                          _c("div", { staticClass: "text-muted small mb-1" }, [
                            _vm._v(_vm._s(_vm.__("total_cost"))),
                          ]),
                          _vm._v(" "),
                          _c(
                            "div",
                            { staticClass: "h6 mb-0 text-secondary fw-bold" },
                            [
                              _vm._v(
                                _vm._s(_vm.$currency) +
                                  " " +
                                  _vm._s(_vm.total_cost.toFixed(2))
                              ),
                            ]
                          ),
                        ]
                    ...
                    _c("div", { staticClass: "col-6 col-md-3" }, [
                      _c(
                        ...
                        [
                          _c("div", { staticClass: "text-muted small mb-1" }, [
                            _vm._v(_vm._s(_vm.__("total_margin"))),
                          ]),
                          _vm._v(" "),
                          _c(
                            "div",
                            {
                              staticClass: "h6 mb-0 fw-bold",
                              class:
                                _vm.total_margin >= 0
                                  ? "text-success"
                                  : "text-danger",
                            ...
                            [
                              _vm._v(
                                _vm._s(_vm.$currency) +
                                  " " +
                                  _vm._s(_vm.total_margin.toFixed(2))
                              ),
                            ]
                          ),
                        ]
                    ...
                    _c("div", { staticClass: "col-6 col-md-3" }, [
                      _c(
                        ...
                        [
                          _c("div", { staticClass: "text-muted small mb-1" }, [
                            _vm._v(_vm._s(_vm.__("overall_margin_pct"))),
                          ]),
                          _vm._v(" "),
                          _c(
                            "div",
                            {
                              staticClass: "h6 mb-0 fw-bold",
                              class:
                                _vm.overall_margin_pct >= 0
                                  ? "text-success"
                                  : "text-danger",
                            },
                            [_vm._v(_vm._s(_vm.overall_margin_pct) + "%")]
                          ),
                        ]
                      ),
                    ]),
