...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  data: function data() {
    return {
      ...
      payment_method: {
        ...
        dpo_payment_method: 0,
        dpo_mode: "",
        dpo_company_token: "",
        dpo_service_type: "",
        dpo_currency_code: "",
        dpo_notification_url: this.$baseUrl + "/dpo/callback"
      },
      record: null
    };
  },
  ...
  methods: {
    getPaymentMethods: function getPaymentMethods() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(this.$apiUrl + '/payment_methods').then(function (response) {
        if (response.data.data) {
          ...
          _this.payment_method.dpo_payment_method = _this.record.dpo_payment_method;
          _this.payment_method.dpo_mode = _this.record.dpo_mode;
          _this.payment_method.dpo_company_token = _this.record.dpo_company_token;
          _this.payment_method.dpo_service_type = _this.record.dpo_service_type;
          _this.payment_method.dpo_currency_code = (_this$record$dpo_curr = _this.record.dpo_currency_code) !== null && _this$record$dpo_curr !== void 0 ? _this$record$dpo_curr : "";
        }
      });
    },
    saveRecord: function saveRecord() {
      ...
      var vm = this;
      if (this.payment_method.cod_payment_method == 1 || this.payment_method.paypal_payment_method == 1 || this.payment_method.razorpay_payment_method == 1 || this.payment_method.paystack_payment_method == 1 || this.payment_method.stripe_payment_method == 1 ||
            ...
            _c("div", { staticClass: "row" }, [
                          ...
                          _c(
                            ...
                            [
                              ...
                              _c("option", { attrs: { value: "USD" } }, [
                                _vm._v(
                                  _vm._s(_vm.__("united_states")) + " - USD"
                                ),
                              ]),
                              _vm._v(" "),
                              ...
                              _c("option", { attrs: { value: "KES" } }, [
                                _vm._v(_vm._s(_vm.__("kenya")) + " - KES"),
                              ]),
                            ]
                          ),
                        ])
              ...
              _c("div", { staticClass: "col-6 mb-4" }, [
                _c("div", { staticClass: "card h-100" }, [
                  _c("div", { staticClass: "card-header" }, [
                    _c("h4", { staticClass: "card-title" }, [
                      _vm._v(_vm._s(_vm.__("dpo_payments"))),
                    ]),
                  ]),
                  _vm._v(" "),
                  _c("div", { staticClass: "card-body" }, [
                    _c("div", { staticClass: "form-group" }, [
                      _c("label", { attrs: { for: "dpo_payment_method" } }, [
                        _vm._v(_vm._s(_vm.__("dpo_payments"))),
                        _c("small", [
                          _vm._v(
                            "[ " +
                      ...
                      _c("div", { staticClass: "form-check form-switch" }, [
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.payment_method.dpo_payment_method,
                              expression: "payment_method.dpo_payment_method",
                            },
                          ],
                          staticClass: "form-check-input",
                          attrs: {
                            id: "dpo_payment_method",
                            type: "checkbox",
                            "true-value": "1",
                            "false-value": "0",
                          },
                          domProps: {
                            checked: _vm.payment_method.dpo_payment_method,
                            checked: Array.isArray(
                              _vm.payment_method.dpo_payment_method
                            )
                              ? _vm._i(
                                  _vm.payment_method.dpo_payment_method,
                                  null
                          ...
                          on: {
                            change: function ($event) {
                              var $$a = _vm.payment_method.dpo_payment_method,
                                $$el = $event.target,
                                $$c = $$el.checked ? "1" : "0"
                              if (Array.isArray($$a)) {
                                var $$v = null,
                    ...
                    _vm._v(" "),
                    _vm.payment_method.dpo_payment_method == 1
                      ? _c("div", { staticClass: "form-group" }, [
                          _c("label", { attrs: { for: "dpo_mode" } }, [
                            _vm._v(_vm._s(_vm.__("dpo_payment_mode")) + " "),
                            _c("small", [
                              _vm._v(
                                "[ " +
                                  _vm._s(_vm.__("sandbox")) +
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.payment_method.dpo_mode,
                                  expression: "payment_method.dpo_mode",
                                },
                              ],
                              staticClass: "form-control form-select",
                              attrs: {
                    ...
                    _vm.payment_method.dpo_payment_method == 1
                      ? _c("div", { staticClass: "form-group" }, [
                          _c("label", { attrs: { for: "dpo_company_token" } }, [
                            _vm._v(_vm._s(_vm.__("dpo_company_token"))),
                          ]),
                          _vm._v(" "),
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.payment_method.dpo_company_token,
                                expression: "payment_method.dpo_company_token",
                              },
                            ],
                            staticClass: "form-control",
                            attrs: {
                    ...
                    _vm.payment_method.dpo_payment_method == 1
                      ? _c("div", { staticClass: "form-group" }, [
                          _c("label", { attrs: { for: "dpo_service_type" } }, [
                            _vm._v(_vm._s(_vm.__("dpo_service_type"))),
                          ]),
                          _vm._v(" "),
                          _c("input", {
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.payment_method.dpo_service_type,
                                expression: "payment_method.dpo_service_type",
                              },
                            ],
                            staticClass: "form-control",
                            attrs: {
                              ...
                              id: "dpo_service_type",
                              placeholder: "DPO Service Type (e.g. 3854)",
                            },
                            domProps: {
                              value: _vm.payment_method.dpo_service_type,
                            },
                    ...
                    _vm.payment_method.dpo_payment_method == 1
                      ? _c("div", { staticClass: "form-group" }, [
                          _c("label", { attrs: { for: "dpo_currency_code" } }, [
                            _vm._v(_vm._s(_vm.__("currency_code")) + " "),
                            _c("small", [
                              _vm._v(
                                "[ " + _vm._s(_vm.__("dpo_supported")) + " ]"
                              ),
                            ]),
                            _vm._v(" "),
                            _vm._m(3),
                              ...
                              directives: [
                                {
                                  name: "model",
                                  rawName: "v-model",
                                  value: _vm.payment_method.dpo_currency_code,
                                  expression:
                                    "payment_method.dpo_currency_code",
                                },
                              ],
                              staticClass: "form-control form-select",
                              attrs: {
                                name: "dpo_currency_code",
                                id: "dpo_currency_code",
                                required:
                                  _vm.payment_method.dpo_payment_method == 1,
                              },
                              on: {
                    ...
                    _vm.payment_method.dpo_payment_method == 1
                      ? _c("div", { staticClass: "form-group" }, [
                          _c(
                            "label",
                            { attrs: { for: "dpo_notification_url" } },
                            [
                              _vm._v(_vm._s(_vm.__("notification_url")) + " "),
                              _c("small", [
                                _vm._v(
                                  _vm._s(_vm.__("set_webhook_url_for_dpo"))
                                ),
                              ]),
                            ]
                          ),
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.payment_method.dpo_notification_url,
                                expression:
                                  "payment_method.dpo_notification_url",
                              },
                            ],
                            staticClass: "form-control",
                            attrs: {
                              type: "text",
                              name: "dpo_notification_url",
                              placeholder: "DPO Webhook URL",
                              disabled: "",
                            },
                            domProps: {
                              value: _vm.payment_method.dpo_notification_url,
...
var staticRenderFns = [
  ...
  function () {
    ...
    return _c(
      "a",
      { attrs: { href: "https://docs.directpay.online/", target: "_BLANK" } },
      [_c("i", { staticClass: "fa fa-link" })]
    )
  },
]
