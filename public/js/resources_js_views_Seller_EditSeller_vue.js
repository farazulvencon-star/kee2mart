...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: (_watch = {
    ...
    deep: true
  }), _defineProperty(_watch, "module_id", function module_id(newVal) {
    if (newVal) {
  ...
  methods: {
    ...
    getCategories: function getCategories() {
      var _this5 = this;
      var moduleId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
      this.isLoading = true;
      var headers = {};
      var mid = moduleId || this.module_id;
      if (mid) {
        headers['X-Module-Id'] = mid;
      }
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(this.$apiUrl + '/categories/main', {
        headers: headers
    ...
    getModules: function getModules() {
      var _this6 = this;
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(this.$apiUrl + '/modules').then(function (response) {
        var data = response.data;
        _this6.modules = data.data;
      });
    },
    getSellerCommission: function getSellerCommission() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(this.$sellerApiUrl + '/seller_commission').then(function (response) {
        var data = response.data;
        _this7.commission = data.data.value;
      });
    },
    getStoreSettings: function getStoreSettings() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(this.$apiUrl + '/store_settings').then(function (response) {
        ...
        _this8.store_settings = data.store_settingsObject;

        // Load store settings values
        data.store_settings.forEach(function (item) {
          if (item.variable === 'one_seller_cart') {
            _this8.store_settings.one_seller_cart = item.value === '1' ? 1 : 0;
          }
          if (item.variable === 'self_pickup_mode') {
            _this8.store_settings.self_pickup_mode = item.value === '1' ? 1 : 0;
          }
        });
      });
    },
    ...
    getCurrentLocation: function getCurrentLocation() {
      ...
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(function (position) {
          _this9.latitude = position.coords.latitude;
          _this9.longitude = position.coords.longitude;
          var latlng = new google.maps.LatLng(_this9.latitude, _this9.longitude);
          _this9.mapConfig(latlng);
        });
      } else {
      ...
      try {
        ...
        Object.keys(data).forEach(function (key) {
          ...
          if (key === 'storeTimings' && data.storeTimings) {
            _this10.storeTimings = data.storeTimings;
          } else if (_this10.hasOwnProperty(key)) {
            _this10[key] = data[key] !== undefined ? data[key] : _this10[key];
          }
        });
        ...
        if (data.translations && this.languages && this.languages.length > 0) {
          this.languages.forEach(function (language) {
            if (data.translations[language.id]) {
              _this10.$set(_this10.translations, language.id, _objectSpread(_objectSpread({}, _this10.translations[language.id]), data.translations[language.id]));
            }
          });
          var defaultLang = this.languages.find(function (lang) {
            return lang.is_default === 1;
    ...
    getSeller: function getSeller() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default().get(this.$apiUrl + '/sellers/edit/' + this.id).then(function (response) {
        ...
        var data = response.data;
        if (data.status === 1) {
          var _this13$record$admin$, _this13$record$admin$2;
          // Set flag to prevent refilling
          _this13.isFormLoaded = true;
          _this13.record = data.data;

          // Helper: show empty string when value is null, undefined, or string "null"
          var emptyIfNull = function emptyIfNull(val) {
            return val != null && val !== "null" ? val : "";
          };
          _this13.admin_id = (_this13$record$admin$ = _this13.record.admin.id) !== null && _this13$record$admin$ !== void 0 ? _this13$record$admin$ : _this13.record.admin_id;
          _this13.email = (_this13$record$admin$2 = _this13.record.admin.email) !== null && _this13$record$admin$2 !== void 0 ? _this13$record$admin$2 : _this13.record.email;
          _this13.mobile = _this13.record.mobile;
          _this13.store_url = _this13.record.store_url;
          _this13.password = "";
          _this13.confirm_password = "";

          // Load translations from the seller object
          var updatedTranslations = _objectSpread({}, _this13.translations);
          if (_this13.record.translations && Array.isArray(_this13.record.translations)) {
            // Convert array of translation objects to object keyed by language_id
            _this13.record.translations.forEach(function (trans) {
          ...
          _this13.languages.forEach(function (language) {
            if (!updatedTranslations[language.id] || !updatedTranslations[language.id].name && !updatedTranslations[language.id].store_name) {
              if (language.is_default) {
                ...
                updatedTranslations[language.id] = {
                  name: emptyIfNull(_this13.record.name),
                  store_name: emptyIfNull(_this13.record.store_name),
                  store_description: emptyIfNull(_this13.record.store_description)
                };
              }
            }
          });
          ...
          var defaultLang = _this13.languages.find(function (lang) {
            return lang.is_default === 1;
          });
          if (defaultLang && updatedTranslations[defaultLang.id]) {
            _this13.name = emptyIfNull(updatedTranslations[defaultLang.id].name) || emptyIfNull(_this13.record.name);
            _this13.store_name = emptyIfNull(updatedTranslations[defaultLang.id].store_name) || emptyIfNull(_this13.record.store_name);
            _this13.store_description = emptyIfNull(updatedTranslations[defaultLang.id].store_description) || emptyIfNull(_this13.record.store_description);
          } else {
            _this13.name = emptyIfNull(_this13.record.name);
            _this13.store_name = emptyIfNull(_this13.record.store_name);
            _this13.store_description = emptyIfNull(_this13.record.store_description);
          }

          // Single assignment for reactivity
          _this13.translations = updatedTranslations;
          _this13.street = emptyIfNull(_this13.record.street);
          _this13.pincode_id = "";
          _this13.city_id = emptyIfNull(_this13.record.city_id) ? _this13.record.city_id.split(",") : [];
          _this13.categories_ids = emptyIfNull(_this13.record.categories) ? _this13.record.categories.split(",") : [];
          _this13.state = emptyIfNull(_this13.record.state);
          _this13.remark = emptyIfNull(_this13.record.remark);
          _this13.account_number = _this13.record.account_number;
          _this13.ifsc_code = emptyIfNull(_this13.record.bank_ifsc_code);
          _this13.bank_name = emptyIfNull(_this13.record.bank_name);
          _this13.account_name = emptyIfNull(_this13.record.account_name);
          _this13.commission = _this13.record.commission;
          _this13.tax_name = emptyIfNull(_this13.record.tax_name);
          _this13.tax_number = emptyIfNull(_this13.record.tax_number);
          _this13.pan_number = emptyIfNull(_this13.record.pan_number);
          _this13.latitude = _this13.record.latitude;
          _this13.longitude = _this13.record.longitude;
          _this13.place_name = emptyIfNull(_this13.record.place_name);
          _this13.formatted_address = emptyIfNull(_this13.record.formatted_address);
          _this13.require_products_approval = _this13.record.require_products_approval;
          // this.customer_privacy = this.record.customer_privacy;
          _this13.view_order_otp = _this13.record.view_order_otp;
          _this13.assign_delivery_boy = _this13.record.assign_delivery_boy;
          _this13.change_order_status_delivered = _this13.record.change_order_status_delivered;

          // Self Pickup fields
          _this13.self_pickup_mode = _this13.record.self_pickup_mode === null || _this13.record.self_pickup_mode === undefined ? 0 : _this13.record.self_pickup_mode;
          _this13.door_step_mode = _this13.record.door_step_mode === null || _this13.record.door_step_mode === undefined ? 1 : _this13.record.door_step_mode;
          _this13.pickup_store_address = emptyIfNull(_this13.record.pickup_store_address);
          _this13.pickup_latitude = _this13.record.pickup_latitude || "";
          _this13.pickup_longitude = _this13.record.pickup_longitude || "";
          _this13.module_id = _this13.record.module_id || "";

          // Load store timings
          if (_this13.record.pickup_store_timings) {
            try {
              var parsedTimings = JSON.parse(_this13.record.pickup_store_timings);
          ...
          if (_this13.pickup_latitude && _this13.pickup_longitude) {
            _this13.pickupCenter = {
              lat: parseFloat(_this13.pickup_latitude),
              lng: parseFloat(_this13.pickup_longitude)
            };
            _this13.pickupMarkers = [{
              position: {
                lat: parseFloat(_this13.pickup_latitude),
                lng: parseFloat(_this13.pickup_longitude)
              }
            }];
            _this13.pickupInfoWindow.position = {
              lat: parseFloat(_this13.pickup_latitude),
              lng: parseFloat(_this13.pickup_longitude)
            };
            _this13.pickupInfoWindow.template = "<b>Pickup Location</b><br>".concat(_this13.pickup_store_address);
          }
          ...
          _this13.center = marker;
          _this13.infoWindow.position = {
            lat: parseFloat(_this13.latitude),
            lng: parseFloat(_this13.longitude)
          };
          _this13.infoWindow.template = "<b>".concat(_this13.place_name, "</b><br>").concat(_this13.formatted_address);
          _this13.infoWindow.open = true;
        } else {
          _this13.showError(data.message);
          setTimeout(function () {
            _this13.$router.back();
          }, 1000);
        }
    ...
    validateDefaultLanguageForTranslation: function validateDefaultLanguageForTranslation() {
      ...
      if (form && !form.reportValidity()) {
        ...
        this.$nextTick(function () {
          _this14.switchToDefaultLanguageTab();
        });
        return false;
      }
    ...
    saveRecord: function saveRecord() {
      ...
      this.languages.forEach(function (language) {
        ...
        var translation = _this15.translations[language.id];
      ...
      var saveAll = /*#__PURE__*/function () {
        var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
          var sellerId, defaultTranslation, formData, url, _response$data, response, apiStatus, _response$data2, apiMessage;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
                  sellerId = _this15.id; // For edit mode
                  defaultTranslation = _this15.translations[defaultLang.id];
                  formData = new FormData(); // Determine URL
                  url = _this15.$apiUrl + '/sellers/save';
                  if (sellerId) {
                    url = _this15.$apiUrl + '/sellers/update';
                    formData.append('id', sellerId);
                    formData.append('admin_id', _this15.admin_id);
                  }
                  ...
                  // All required fields
                  formData.append('email', _this15.email);
                  formData.append('mobile', _this15.mobile);
                  formData.append('store_url', _this15.store_url);

                  // Password only for new sellers or when changing
                  if (!sellerId) {
                    formData.append('password', _this15.password);
                    formData.append('confirm_password', _this15.confirm_password);
                  ...
                  formData.append('street', _this15.street);
                  formData.append('pincode_id', _this15.pincode_id);
                  formData.append('city_id', _this15.city_id);
                  formData.append('categories_ids', _this15.categories_ids);
                  formData.append('state', _this15.state);
                  formData.append('remark', _this15.remark);
                  formData.append('account_number', _this15.account_number);
                  formData.append('ifsc_code', _this15.ifsc_code);
                  formData.append('bank_name', _this15.bank_name);
                  formData.append('account_name', _this15.account_name);
                  formData.append('commission', _this15.commission);
                  formData.append('tax_name', _this15.tax_name);
                  formData.append('tax_number', _this15.tax_number);
                  formData.append('pan_number', _this15.pan_number);
                  formData.append('latitude', _this15.latitude);
                  formData.append('longitude', _this15.longitude);
                  formData.append('place_name', _this15.place_name);
                  formData.append('formatted_address', _this15.formatted_address);
                  formData.append('require_products_approval', _this15.require_products_approval);
                  formData.append('view_order_otp', _this15.view_order_otp);
                  formData.append('assign_delivery_boy', _this15.assign_delivery_boy);
                  formData.append('change_order_status_delivered', _this15.change_order_status_delivered);
                  formData.append('self_pickup_mode', _this15.self_pickup_mode);
                  formData.append('door_step_mode', _this15.door_step_mode);
                  formData.append('module_id', _this15.module_id);
                  formData.append('pickup_store_address', _this15.pickup_store_address);
                  formData.append('pickup_latitude', _this15.pickup_latitude);
                  formData.append('pickup_longitude', _this15.pickup_longitude);
                  formData.append('pickup_store_timings', JSON.stringify(_this15.storeTimings));
                  formData.append('status', _this15.status);
                  ...
                  if (_this15.store_logo) {
                    formData.append('store_logo', _this15.store_logo);
                  }
                  if (_this15.national_id_card) {
                    formData.append('national_id_card', _this15.national_id_card);
                  }
                  if (_this15.address_proof) {
                    formData.append('address_proof', _this15.address_proof);
                  }
                  _context.prev = 47;
                  _context.next = 50;
                ...
                case 50:
                  ...
                  apiStatus = response === null || response === void 0 ? void 0 : (_response$data = response.data) === null || _response$data === void 0 ? void 0 : _response$data.status;
                  if (!(apiStatus !== 1)) {
                    _context.next = 55;
                    break;
                  }
                  apiMessage = (response === null || response === void 0 ? void 0 : (_response$data2 = response.data) === null || _response$data2 === void 0 ? void 0 : _response$data2.message) || __('something_went_wrong');
      ...
      saveAll().then(function () {
        ...
        } else if (error !== null && error !== void 0 && (_error$response3 = error.response) !== null && _error$response3 !== void 0 && (_error$response3$data = _error$response3.data) !== null && _error$response3$data !== void 0 && _error$response3$data.message) {
                                                              ...
                                                              _c(
                                                                ...
                                                                [
                                                                  ...
                                                                  _c(
                                                                    ...
                                                                    {
                                                                      staticClass:
                                                                        "btn btn-danger d-inline-flex align-items-center justify-content-center",
                                                                      attrs: {
                                                                        "data-toggle-class":
                                                                          "btn-danger",
                                                                        "data-toggle-passive-class":
                                                        ...
                                                        _c(
                                                          ...
                                                          [
                                                            ...
                                                            _c(
                                                              ...
                                                              {
                                                                staticClass:
                                                                  "text-danger d-block font-size-13 mt-1",
                                                              },
                                                              [
                                                                _vm._v(
                                                                  "\n                                                                    " +
                                                            ...
                                                            _c(
                                                              ...
                                                              {
                                                                staticClass:
                                                                  "text text-primary font-size-13 d-block",
                                                              },
                                                              [
                                                                _vm._v(
                                                                  "\n                                                                    " +
