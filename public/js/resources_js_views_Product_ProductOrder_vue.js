    ...
    fetchActiveLanguages: function fetchActiveLanguages() {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/active_languages').then(function (response) {
        if (response.data.data && Array.isArray(response.data.data)) {
          ...
          var currentLanguage = _this4.activeLanguages.find(function (lang) {
            return lang.code === appLocale;
          });
          if (currentLanguage) {
            _this4.currentLanguageId = currentLanguage.id;
          } else {
            var defaultLanguage = _this4.activeLanguages.find(function (lang) {
              return lang.is_default === 1;
            });
            if (defaultLanguage) {
              _this4.currentLanguageId = defaultLanguage.id;
            }
          }
        }
          ...
          _c(
            ...
            [
              _c("h4", { staticClass: "card-title mb-4" }, [
                _vm._v(_vm._s(_vm.__("products_order_list"))),
              ]),
              _vm._v(" "),
              _c(
                "b-row",
                { staticClass: "mb-4" },
                [
                  _c("b-col", { attrs: { md: "6", lg: "5" } }, [
                    _c("div", { staticClass: "figma-filter-group mb-2" }, [
                    ...
                    _c(
                      "span",
                      { staticClass: "text-danger d-block font-size-13 mt-2" },
                      [
                        _vm._v(
                          _vm._s(
                            _vm.__(
                        ...
                        _c(
                          ...
                          [
                            ...
                            _c(
                              "button",
                              {
                                staticClass: "btn btn-sm btn-figma-filter px-3",
                                attrs: { type: "button" },
                                on: { click: _vm.orderList },
                              },
                              [
                                _c("i", { staticClass: "fa fa-sort me-1" }),
                                _vm._v(
                                  "\n                                    " +
                                          ...
                                          _c(
                                            ...
                                            [
                                              _c(
                                                ...
                                                {
                                                  staticClass:
                                                    "order-number text-muted font-weight-bold text-end",
                                                  staticStyle: {
                                                    width: "30px",
                                                    "margin-right": "8px",
                                                  },
                                              ...
                                              _c(
                                                ...
                                                {
                                                  staticClass:
                                                    "product-id text-muted text-end",
                                                  staticStyle: {
                                                    width: "35px",
                                                    "margin-right": "12px",
                                                  },
                                              ...
                                              _c(
                                                ...
                                                {
                                                  staticClass:
                                                    "product-image-container d-flex align-items-center justify-content-center",
                                                  staticStyle: {
                                                    width: "35px",
                                                    height: "35px",
                                                    "margin-right": "12px",
                                              ...
                                              _c(
                                                ...
                                                {
                                                  staticClass:
                                                    "product-name font-weight-semibold text-start flex-grow-1",
                                                },
                                                [
                                                  _vm._v(
                                                    _vm._s(
                                                      _vm.getTranslatedProductName(
                                                        product
                                                      )
                                                    )
                                                  ),
                      ...
                      _c(
                        ...
                        [
                          _c(
                            ...
                            [
                              !_vm.isLoading
                                ? _c("i", { staticClass: "fa fa-save me-2" })
                                : _vm._e(),
                              _vm._v(
                                "\n                                " +
