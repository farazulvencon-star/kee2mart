"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_Setting_PrivacyPolicy_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Setting/PrivacyPolicy.vue?vue&type=script&lang=js":
/*!**********************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Setting/PrivacyPolicy.vue?vue&type=script&lang=js ***!
  \**********************************************************************************************************************************************************************************************************/
  ...
  methods: {
    ...
    fetchActiveLanguages: function fetchActiveLanguages() {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_0___default().get(this.$apiUrl + "/active_languages").then(function (res) {
        ...
        var def = _this2.languages.find(function (l) {
          return l.is_default === 1;
        });
        _this2.defaultLanguageId = def ? def.id : null;
        _this2.initTranslations();
    ...
    getPrivacyPolicy: function getPrivacyPolicy() {
      var _this3 = this;
      axios__WEBPACK_IMPORTED_MODULE_0___default().get(this.$apiUrl + "/privacy_policy").then(function (res) {
        _this3.record = res.data.data;
        if (!_this3.record) return;
        _this3.record.forEach(function (item) {
          try {
            var parsed = JSON.parse(item.value);
            _this3.languages.forEach(function (lang) {
              if (parsed[lang.code]) {
                _this3.translations[lang.id][item.variable] = parsed[lang.code];
              }
            });
          } catch (_unused) {
            // fallback for old single-language data
            if (_this3.defaultLanguageId) {
              _this3.translations[_this3.defaultLanguageId][item.variable] = item.value;
            }
          }
        });
      });
    ...
    validateDefaultLanguage: function validateDefaultLanguage() {
      ...
      var requiredFields = ['privacy_policy', 'returns_and_exchanges_policy', 'shipping_policy', 'cancellation_policy', 'terms_conditions'];
      var emptyFields = requiredFields.filter(function (field) {
        return !(def[field] && String(def[field]).trim());
      });
      if (emptyFields.length > 0) {
        var message = __('please_fill_all_required_fields_in_default_language') || 'Please fill all required fields in the default language.';
    ...
    saveRecord: function saveRecord() {
      ...
      this.isLoading = true;
      var payload = {};
      Object.keys(this.policyLabels).forEach(function (variable) {
        var dataByLang = {};
        _this5.languages.forEach(function (lang) {
          dataByLang[lang.code] = _this5.translations[lang.id][variable] || "";
        });
        payload[variable] = JSON.stringify(dataByLang);
      });
      axios__WEBPACK_IMPORTED_MODULE_0___default().post(this.$apiUrl + "/privacy_policy/save", payload).then(function (res) {
...
/***/ "./resources/js/views/Setting/PrivacyPolicy.vue":
/*!******************************************************!*\
  !*** ./resources/js/views/Setting/PrivacyPolicy.vue ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _PrivacyPolicy_vue_vue_type_template_id_40a7242c__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PrivacyPolicy.vue?vue&type=template&id=40a7242c */ "./resources/js/views/Setting/PrivacyPolicy.vue?vue&type=template&id=40a7242c");
/* harmony import */ var _PrivacyPolicy_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./PrivacyPolicy.vue?vue&type=script&lang=js */ "./resources/js/views/Setting/PrivacyPolicy.vue?vue&type=script&lang=js");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _PrivacyPolicy_vue_vue_type_template_id_40a7242c__WEBPACK_IMPORTED_MODULE_0__.render,
  _PrivacyPolicy_vue_vue_type_template_id_40a7242c__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/Setting/PrivacyPolicy.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/views/Setting/PrivacyPolicy.vue?vue&type=script&lang=js":
/*!******************************************************************************!*\
  !*** ./resources/js/views/Setting/PrivacyPolicy.vue?vue&type=script&lang=js ***!
  \******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/views/Setting/PrivacyPolicy.vue?vue&type=template&id=40a7242c":
/*!************************************************************************************!*\
  !*** ./resources/js/views/Setting/PrivacyPolicy.vue?vue&type=template&id=40a7242c ***!
  \************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PrivacyPolicy_vue_vue_type_template_id_40a7242c__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PrivacyPolicy_vue_vue_type_template_id_40a7242c__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_PrivacyPolicy_vue_vue_type_template_id_40a7242c__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./PrivacyPolicy.vue?vue&type=template&id=40a7242c */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Setting/PrivacyPolicy.vue?vue&type=template&id=40a7242c");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Setting/PrivacyPolicy.vue?vue&type=template&id=40a7242c":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Setting/PrivacyPolicy.vue?vue&type=template&id=40a7242c ***!
  \***************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    _c("div", { staticClass: "page-heading" }, [
      _c("div", { staticClass: "row" }, [
        _c("div", { staticClass: "col-12 col-md-6 order-md-1 order-last" }, [
          _c("h3", [_vm._v(_vm._s(_vm.__("privacy_policy_terms_conditions")))]),
        ]),
        _vm._v(" "),
            ...
            [
              _c("ol", { staticClass: "breadcrumb" }, [
                ...
                _c(
                  ...
                  [_vm._v(_vm._s(_vm.__("privacy_policy_terms_conditions")))]
                ),
              ]),
            ]
          ),
          ...
          [
            _c("div", { staticClass: "figma-main-section-card" }, [
              _c("div", { staticClass: "card-body p-0" }, [
                _c("div", { staticClass: "figma-action-bar-row" }, [
                  _c("h4", { staticClass: "card-title mb-0" }, [
                    _vm._v(
                      "\n                                " +
                        _vm._s(_vm.__("update_privacy_policy")) +
                        "\n                            "
                    ),
                  ]),
                ]),
                                        ...
                                        [
                                          ...
                                          _c("editor", {
                                            ...
                                            model: {
                                              ...
                                              expression:
                                                "translations[language.id][variable]",
                                            },
                                          }),
                                        ],
                                        1
