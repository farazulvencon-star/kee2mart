(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_views_Subscriptions_SubscriptionsFaqs_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=script&lang=js":
/*!********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=script&lang=js ***!
  \********************************************************************************************************************************************************************************************************************/
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data: function data() {
    return {
      ...
      // Store all FAQs
      faqs: [],
      // Displayed FAQs for drag-and-drop mode
      expandedFaqs: {},
  ...
  computed: {
    ...
    translatedFaqs: function translatedFaqs() {
      ...
      return this.allFaqs.map(function (faq) {
        var translated = _objectSpread({}, faq);
        if (faq.translations && Array.isArray(faq.translations)) {
          var _t$question, _t$answer;
          var t = faq.translations.find(function (tr) {
            return tr.language_id === _this.currentLanguageId;
          });

          // fallback logic (same pattern as category)
          if (t !== null && t !== void 0 && (_t$question = t.question) !== null && _t$question !== void 0 && _t$question.trim()) {
            translated.question = t.question;
          }
          if (t !== null && t !== void 0 && (_t$answer = t.answer) !== null && _t$answer !== void 0 && _t$answer.trim()) {
    ...
    modalTitle: function modalTitle() {
      var title = this.form.id ? __('edit') : __('add');
      title += " ";
  ...
  watch: {
    ...
    enableDragDrop: function enableDragDrop(newVal) {
      if (newVal) {
        // When enabling drag-drop, show all FAQs (no pagination)
        this.faqs = _toConsumableArray(this.allFaqs);
  ...
  methods: {
    loadFaqWithTranslations: function loadFaqWithTranslations() {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/subscription_faqs', {
        ...
        if (response.data.data) {
          ...
          var faqs = Array.isArray(response.data.data) ? response.data.data : [response.data.data];
          var faq = faqs.length > 0 ? faqs[0] : null;
          if (!faq) {
          ...
          /* ---------------- BASE DATA ---------------- */
          _this3.form.id = faq.id;
          _this3.form.sort_order = faq.sort_order;
          _this3.form.status = faq.status;
          ...
          _this3.languages.forEach(function (language) {
            if (!updatedTranslations[language.id] || !updatedTranslations[language.id].question && !updatedTranslations[language.id].answer) {
    ...
    fetchActiveLanguages: function fetchActiveLanguages() {
      ...
      return axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/active_languages').then(function (res) {
        ...
        if (currentLang) {
          _this4.currentLanguageId = currentLang.id;
        } else {
          var defaultLang = _this4.languages.find(function (l) {
            return l.is_default === 1;
          });
          _this4.currentLanguageId = (defaultLang === null || defaultLang === void 0 ? void 0 : defaultLang.id) || null;
        }
        _this4.initializeTranslations(); // do NOT remove
      })["catch"](function () {
    ...
    initializeTranslations: function initializeTranslations() {
      var existingTranslations = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      var baseFaq = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var map = {};
      this.languages.forEach(function (lang) {
        var _ref, _found$question, _ref2, _found$answer;
        var found = existingTranslations.find(function (t) {
          return t.language_id === lang.id;
        });
        map[lang.id] = {
          language_id: lang.id,
          question: (_ref = (_found$question = found === null || found === void 0 ? void 0 : found.question) !== null && _found$question !== void 0 ? _found$question : lang.is_default ? baseFaq === null || baseFaq === void 0 ? void 0 : baseFaq.question : '') !== null && _ref !== void 0 ? _ref : '',
          answer: (_ref2 = (_found$answer = found === null || found === void 0 ? void 0 : found.answer) !== null && _found$answer !== void 0 ? _found$answer : lang.is_default ? baseFaq === null || baseFaq === void 0 ? void 0 : baseFaq.answer : '') !== null && _ref2 !== void 0 ? _ref2 : ''
        };
      });
    ...
    validateDefaultLanguage: function validateDefaultLanguage() {
      ...
      var t = (_this$form$translatio = this.form.translations) === null || _this$form$translatio === void 0 ? void 0 : _this$form$translatio[defaultLang.id];
    ...
    getFaqs: function getFaqs() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().get(this.$apiUrl + '/subscription_faqs/', {
        ...
        if (response.data.status === 1) {
          _this6.allFaqs = response.data.data || [];
          _this6.totalRows = response.data.total || _this6.allFaqs.length;
          // Update displayed FAQs based on current mode
          if (_this6.enableDragDrop) {
            // When drag-drop is enabled, show all FAQs
            _this6.faqs = _toConsumableArray(_this6.allFaqs);
          }
          // When drag-drop is disabled, b-table handles pagination automatically
        } else {
          _this6.showError(response.data.message);
          _this6.allFaqs = [];
          _this6.faqs = [];
          _this6.totalRows = 0;
        }
    ...
    deleteFaq: function deleteFaq(index, id) {
      var _this7 = this;
      this.$swal.fire({
        ...
        if (result.value) {
          ...
          axios__WEBPACK_IMPORTED_MODULE_1___default().post(_this7.$apiUrl + "/subscription_faqs/delete/".concat(id)).then(function (response) {
            ...
            if (response.data.status === 1) {
              ...
              var allFaqsIndex = _this7.allFaqs.findIndex(function (faq) {
                return faq.id === id;
              });
              if (allFaqsIndex !== -1) {
                _this7.allFaqs.splice(allFaqsIndex, 1);
              }

              // Remove from faqs array (for drag-drop mode)
              if (_this7.enableDragDrop) {
                var faqsIndex = _this7.faqs.findIndex(function (faq) {
                  return faq.id === id;
                });
                if (faqsIndex !== -1) {
                  _this7.faqs.splice(faqsIndex, 1);
                }
              }
              _this7.totalRows = _this7.allFaqs.length;
    ...
    editFaq: function editFaq(faq) {
      ...
      this.resetForm();
      this.fetchActiveLanguages().then(function () {
        _this9.form.id = faq.id;
        _this9.form.sort_order = faq.sort_order;
        _this9.form.status = faq.status;
        _this9.initializeTranslations(faq.translations || [], faq);
        _this9.create_new = true;
      });
    },
    ...
    saveFaq: function saveFaq() {
      ...
      var url = this.$apiUrl + '/subscription_faqs/save';
      if (this.form.id) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post(url, payload).then(function (response) {
        ...
        if (response.data.status === 1) {
          ...
          _this10.showError(response.data.message);
        }
      })["catch"](function () {
    ...
    getFaqIndex: function getFaqIndex(id) {
      return this.faqs.findIndex(function (faq) {
        return faq.id === id;
      });
    },
    // Update FAQs order after drag and drop
    updateFaqsOrder: function updateFaqsOrder() {
      var _this11 = this;
      ...
      this.faqs.forEach(function (faq, index) {
        faq.sort_order = index + 1;
      });

      // Also update allFaqs to keep them in sync
      this.allFaqs = _toConsumableArray(this.faqs);

      // Send update to server
      this.isUpdatingOrder = true;
      var formData = this.faqs.map(function (faq) {
        return {
          id: faq.id,
      ...
      axios__WEBPACK_IMPORTED_MODULE_1___default().post(this.$apiUrl + '/subscription_faqs/update_order', {
        ...
        _this11.isUpdatingOrder = false;
        if (response.data.status === 1) {
          _this11.showMessage("success", response.data.message || __('order_updated_successfully'));
          // Update allFaqs to reflect new order
          _this11.allFaqs = _toConsumableArray(_this11.faqs);
        } else {
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=style&index=0&id=0512156b&scoped=true&lang=css":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=style&index=0&id=0512156b&scoped=true&lang=css ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=style&index=1&id=0512156b&lang=css":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=style&index=1&id=0512156b&lang=css ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SubscriptionsFaqs_vue_vue_type_style_index_0_id_0512156b_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SubscriptionsFaqs.vue?vue&type=style&index=0&id=0512156b&scoped=true&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=style&index=0&id=0512156b&scoped=true&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SubscriptionsFaqs_vue_vue_type_style_index_0_id_0512156b_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! !../../../../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ "./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SubscriptionsFaqs_vue_vue_type_style_index_1_id_0512156b_lang_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SubscriptionsFaqs.vue?vue&type=style&index=1&id=0512156b&lang=css */ "./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=style&index=1&id=0512156b&lang=css");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SubscriptionsFaqs_vue_vue_type_style_index_1_id_0512156b_lang_css__WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/***/ "./resources/js/views/Subscriptions/SubscriptionsFaqs.vue":
/*!****************************************************************!*\
  !*** ./resources/js/views/Subscriptions/SubscriptionsFaqs.vue ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _SubscriptionsFaqs_vue_vue_type_template_id_0512156b_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./SubscriptionsFaqs.vue?vue&type=template&id=0512156b&scoped=true */ "./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=template&id=0512156b&scoped=true");
/* harmony import */ var _SubscriptionsFaqs_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./SubscriptionsFaqs.vue?vue&type=script&lang=js */ "./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=script&lang=js");
/* harmony import */ var _SubscriptionsFaqs_vue_vue_type_style_index_0_id_0512156b_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./SubscriptionsFaqs.vue?vue&type=style&index=0&id=0512156b&scoped=true&lang=css */ "./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=style&index=0&id=0512156b&scoped=true&lang=css");
/* harmony import */ var _SubscriptionsFaqs_vue_vue_type_style_index_1_id_0512156b_lang_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./SubscriptionsFaqs.vue?vue&type=style&index=1&id=0512156b&lang=css */ "./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=style&index=1&id=0512156b&lang=css");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_4__["default"])(
  _SubscriptionsFaqs_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"],
  _SubscriptionsFaqs_vue_vue_type_template_id_0512156b_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render,
  _SubscriptionsFaqs_vue_vue_type_template_id_0512156b_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "0512156b",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/views/Subscriptions/SubscriptionsFaqs.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);

/***/ }),

/***/ "./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=script&lang=js":
/*!****************************************************************************************!*\
  !*** ./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=script&lang=js ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SubscriptionsFaqs_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SubscriptionsFaqs.vue?vue&type=script&lang=js */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5.use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=script&lang=js");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_SubscriptionsFaqs_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=style&index=0&id=0512156b&scoped=true&lang=css":
/*!************************************************************************************************************************!*\
  !*** ./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=style&index=0&id=0512156b&scoped=true&lang=css ***!
  \************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SubscriptionsFaqs_vue_vue_type_style_index_0_id_0512156b_scoped_true_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader/dist/cjs.js!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SubscriptionsFaqs.vue?vue&type=style&index=0&id=0512156b&scoped=true&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=style&index=0&id=0512156b&scoped=true&lang=css");


/***/ }),

/***/ "./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=style&index=1&id=0512156b&lang=css":
/*!************************************************************************************************************!*\
  !*** ./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=style&index=1&id=0512156b&lang=css ***!
  \************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_SubscriptionsFaqs_vue_vue_type_style_index_1_id_0512156b_lang_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader/dist/cjs.js!../../../../node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SubscriptionsFaqs.vue?vue&type=style&index=1&id=0512156b&lang=css */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-9.use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9.use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=style&index=1&id=0512156b&lang=css");


/***/ }),

/***/ "./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=template&id=0512156b&scoped=true":
/*!**********************************************************************************************************!*\
  !*** ./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=template&id=0512156b&scoped=true ***!
  \**********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SubscriptionsFaqs_vue_vue_type_template_id_0512156b_scoped_true__WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   staticRenderFns: () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SubscriptionsFaqs_vue_vue_type_template_id_0512156b_scoped_true__WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_SubscriptionsFaqs_vue_vue_type_template_id_0512156b_scoped_true__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SubscriptionsFaqs.vue?vue&type=template&id=0512156b&scoped=true */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=template&id=0512156b&scoped=true");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=template&id=0512156b&scoped=true":
/*!*************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/views/Subscriptions/SubscriptionsFaqs.vue?vue&type=template&id=0512156b&scoped=true ***!
  \*************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
                  ...
                  _c("div", { staticClass: "card-body p-0" }, [
                      ...
                      [
                        _c(
                          ...
                          [
                            ...
                            _c(
                              "div",
                              { staticClass: "form-check form-switch mb-0" },
                              [
                                _c("input", {
                                  directives: [
                                    {
                                ...
                                _c(
                                  ...
                                  {
                                    staticClass:
                                      "form-check-label text-nowrap ms-2",
                                    attrs: { for: "dragDropSwitch" },
                                  },
                                  [
                                    _vm._v(
                                      "\n                                            " +
                            ...
                            _vm.$can("subscription_faq_create")
                              ? _c(
                                  ...
                                  [
                                    ...
                                    _c("span", [
                                      _vm._v(
                                        _vm._s(_vm.__("add_subscription_faq"))
                                      ),
                                    ]),
                                  ]
                                )
                    ...
                    _vm.enableDragDrop
                      ? _c("div", { staticClass: "table-responsive" }, [
                          _c(
                            "table",
                            { staticClass: "table figma-table mb-0" },
                            [
                              _c("thead", [
                                _c("tr", [
                                  _c(
                                  ...
                                  _c("th", [
                                    _vm._v(
                                      _vm._s(
                                        _vm.__("frequently_asked_questions")
                                      )
                                    ),
                                  ]),
                                  _vm._v(" "),
                              ...
                              _c(
                                ...
                                _vm._l(_vm.translatedFaqs, function (faq) {
                                  return _c(
                                    ...
                                    {
                                      key: faq.id,
                                      staticClass: "figma-tr align-middle",
                      ...
                      [
                        _c(
                          ...
                          [
                            ...
                            _vm._v('"showing-bold\\">' + _vm._s(_vm.pageEnd)),
                            _vm._v(
                              "\n                                    " +
                                _vm._s(_vm.__("of")) +
                                " "
                            ),
                            _vm._v('"showing-bold\\">' + _vm._s(_vm.totalRows)),
                          ]
                        ),
                        _vm._v(" "),
                        _c(
          ...
          _c(
            ...
            [
              _c(
                "b-button",
                {
                  attrs: { variant: "primary", disabled: _vm.isSubmitting },
                  on: {
                    click: function ($event) {
          ...
          _vm.isLoadingLanguages
            ? _c(
                ...
                [
                  _c("b-spinner"),
                  _vm._v(" "),
                  _c("p", [_vm._v(_vm._s(_vm.__("loading_languages")))]),
                ],
                1
              )
            : _c(
                "form",
                {
                  ...
                  on: {
                    submit: function ($event) {
                      ...
                      return _vm.saveFaq.apply(null, arguments)
                    },
                  },
                },
                [
                  _vm.languages.length &&
                  Object.keys(_vm.form.translations).length
                    ? _c(
                        "b-tabs",
                        {
                                  ...
                                  _c("input", {
                                    directives: [
                                      {
                                        ...
                                        value:
                                          _vm.form.translations[language.id]
                                            .question,
                                        expression:
                                          "form.translations[language.id].question",
                                      },
                                    ],
                                    ...
                                    attrs: {
                                      ...
                                      required: language.is_default
                                        ? true
                                        : undefined,
                                      placeholder: _vm.__("enter_question"),
                                      maxlength: "1000",
                                    },
                                    domProps: {
                                      value:
                                    ...
                                    directives: [
                                      {
                                        ...
                                        value:
                                          _vm.form.translations[language.id]
                                            .answer,
                                        expression:
                                          "form.translations[language.id].answer",
                                      },
                                    ],
                                    staticClass: "form-control",
                                    attrs: {
                                      ...
                                      required: language.is_default
                                        ? true
                                        : undefined,
                                      placeholder: _vm.__("enter_answer"),
                                      maxlength: "1000",
                                    },
                                    domProps: {
                                      value:
