...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    sellers_options: function sellers_options() {
      var temp = [];
    ...
    delivery_boys_options: function delivery_boys_options() {
      var temp = [];
      this.delivery_boys.forEach(function (delivery_boy) {
        temp.push({
          id: delivery_boy.id,
          text: delivery_boy.name
        });
      });
      return temp;
    }
  ...
  methods: {
    ...
    saveRecord: function saveRecord() {
      ...
      var typeIds = Array.isArray(this.type_ids) ? this.type_ids.join(',') : this.type_ids || '';
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  created: function created() {
    var _this = this;
    this.showCreateModal();
    this.notificationSavedHandler = function (message) {
  ...
  methods: {
    getNotifications: function getNotifications() {
      ...
      axios.get(this.$apiUrl + '/notifications').then(function (response) {
        ...
        _this2.delivery_boys = response.data.data.delivery_boys;
              ...
              ? _c(
                  ...
                  [
                    _c("label", [
                      _vm._v(" " + _vm._s(_vm.__("customer"))),
                      _c("small", [
                        _vm._v("( Ex : 100,205, 360 comma separated )"),
                      ]),
                    ]),
                    _vm._v(" "),
                    _c("i", { staticClass: "text-danger" }, [_vm._v("*")]),
                  ...
                  [
                    ...
                    _c("Select2", {
                      attrs: {
                        ...
                        options: _vm.delivery_boys_options,
                        settings: {
                          multiple: "multiple",
                          width: "100%",
                          dropdownParent: "#mymodal",
            ...
            _vm.type === "category"
              ? _c("div", { staticClass: "form-group" }, [
                  ...
                  _c(
                    ...
                    [
                      _c("option", [_vm._v(_vm._s(_vm.__("select_category")))]),
                      _vm._v(" "),
          ...
          _c("nav", { attrs: { "aria-label": "breadcrumb" } }, [
            _c("ol", { staticClass: "breadcrumb mb-0" }, [
              ...
              _c(
                ...
                [
                  _vm._v(
                    _vm._s(_vm.__("send_notification")) + "\n                "
                  ),
                ]
              ),
            ]),
      ...
      _vm.create_new || _vm.edit_record
        ? _c("app-edit-record", {
            attrs: {
              ...
              users: _vm.users,
              sellers: _vm.sellers,
              delivery_boys: _vm.delivery_boys,
