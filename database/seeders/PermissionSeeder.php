...
class PermissionSeeder extends Seeder
{
    public function run()
    {
        ...
        $permissionsToSeed = [
            ...
            /*Orders*/
            [
                'name' => ['order_list', 'order_update', 'order_delete', 'self_pickup_order_list', 'self_pickup_order_update', 'self_pickup_order_delete'],
                'category_name' => 'order',
                'default_roles' => ['Super Admin', 'Admin']
            ],
            ...
            /*Sellers*/
            [
                'name' => ['seller_list', 'seller_create', 'seller_update', 'seller_delete', 'seller_requests', 'seller_wallet_transactions', 'manage_privacy_policy_seller_app'],
            ...
            [
                'name' => [
                    ...
                    'delivery_boy_delete',
                    'fund_transfers_list',
                    'fund_transfers_create',
                    'cash_collection_list',
                    'cash_collection_create',
                    'manage_privacy_policy_delivery_boy',
                    'salary_list',
                    'salary_create',
                    'salary_update',
                    'salary_delete'
            ...
            /*email_template*/
            [
                'name' => ['email_templates', 'create_email_template', 'update_email_template', 'delete_email_template', 'manage_emails', 'send_email', 'delete_send_email'],
            ...
            [
                'name' => [
                    'general_settings',
                    'manage_social_media_list',
                    'manage_social_media_create',
                    'manage_social_media_delete',
                    'manage_social_media_update'
                ],
            ...
            /*subscriptions*/
            [
                'name' => ['subscription_list', 'subscription_create', 'subscription_update', 'subscription_delete'],
                'category_name' => 'subscriptions',
                'default_roles' => ['Super Admin', 'Admin']
            ],
            /*subscriptions_faqs*/
            [
                'name' => ['subscription_faq_list', 'subscription_faq_create', 'subscription_faq_update', 'subscription_faq_delete'],
                'category_name' => 'subscriptions',
                'default_roles' => ['Super Admin', 'Admin']
            ],
            /*languages*/
            ...
            [
                'name' => [
                    'featured_section_list',
                    'featured_section_create',
                    'featured_section_update',
                    'featured_section_delete'
                ],
            ...
            /*customer*/
            [
                'name' => ['customer_list', 'customer_update', 'manage_wishlists', 'transaction_list', 'manage_customer_wallet', 'product_request_list', 'product_request_update', 'product_request_delete', 'manage_privacy_policy'],
            ...
            /*report*/
            [
                'name' => ['product_sales_reports', 'sales_reports', 'commission_reports'],
            ...
            /*module*/
            [
                'name' => ['module_list', 'module_create', 'module_update', 'module_delete'],
        ...
        $permissionsToSeed = [
            ...
            /*Orders*/
            [
                'name' => ['order_list', 'order_update', 'order_delete', 'self_pickup_order_list', 'self_pickup_order_update'],
                'category_name' => 'order',
                'default_roles' => ['Seller']
            ],
