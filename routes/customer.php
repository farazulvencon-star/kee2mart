...
header('Access-Control-Allow-Headers: Origin, Content-Type, Authorization, x-access-key, X-Auth-Token, X-Module-Id');
...
Route::group(['middleware' => ['auth.customer']], function () {
    ...
    // Guest
    Route::get('modules', [\App\Http\Controllers\API\ModulesApiController::class, 'index']);
    ...
    Route::get('blogs', [\App\Http\Controllers\API\Customer\BasicApiController::class, 'getBlogs']);
    Route::get('blog_categories', [\App\Http\Controllers\API\Customer\BasicApiController::class, 'getBlogCategories']);
    Route::post('blog_view_count', [\App\Http\Controllers\API\BlogsApiController::class, 'trackBlogView']);
    Route::get('blogs/most_viewed', [\App\Http\Controllers\API\BlogsApiController::class, 'getMostViewedBlogs']);
    Route::get('blog_popular_tags', [\App\Http\Controllers\API\BlogsApiController::class, 'getPopularBlogTags']);

    Route::get('subscription_plans', [\App\Http\Controllers\API\Customer\BasicApiController::class, 'getPlans']);
    Route::get('subscription_faqs', [\App\Http\Controllers\API\Customer\BasicApiController::class, 'getSubscriptionFaqs']);
    ...
    Route::group(['middleware' => ['auth:api-customers']], function () {
        ...
        Route::group(['prefix' => 'user_product_requests'], function () {
            Route::post('/add', [\App\Http\Controllers\API\ProductRequestApiController::class, 'create']);
            Route::get('/list', [\App\Http\Controllers\API\ProductRequestApiController::class, 'getAuthUserRequests']);
        });
        ...
        Route::group(['prefix' => 'sections'], function () {
            ...
            Route::post('/add_recently_visited_product', [\App\Http\Controllers\API\Customer\SectionsApiController::class, 'addRecentlyVisitedProduct']);
        });
        Route::group(['prefix' => 'products'], function () {
            ...
            Route::get('recently_visited', [\App\Http\Controllers\API\Customer\ProductsApiController::class, 'getRecentlyVisitedProducts']);
        });
        ...
        Route::get('user_active_plan', [\App\Http\Controllers\API\SubscriptionPlansApiController::class, 'getPlan']);
