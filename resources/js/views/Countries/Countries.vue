<template>
    <div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                ...
                                <div class="form-check form-check-inline d-inline-block">
                                    <input class="form-check-input" type="radio" id="colorModeGlobal" value="global" v-model="globalSettings.country_background_color_mode">
                                ...
                                <div class="form-check form-check-inline d-inline-block ms-3">
                                    <input class="form-check-input" type="radio" id="colorModeItemWise" value="item-wise" v-model="globalSettings.country_background_color_mode">
                                    <label class="form-check-label ms-1" for="colorModeItemWise">{{ __('item_wise') || 'Item Wise' }}</label>
                                </div>
                            </div>
                        </div>
                        <div class="row" v-if="globalSettings.country_background_color_mode === 'global'">
                            <div class="col-md-6 form-group mb-0">
                                <label>{{ __('country_light_theme_background') || 'Country Light Theme Background' }}</label>
                                <div class="d-flex w-100 mt-1" style="gap: 10px; align-items: center;">
                                    <input type="text" v-model="globalSettings.country_background_color_light_theme" class="form-control">
                                    <input type="color" :value="(globalSettings.country_background_color_light_theme && globalSettings.country_background_color_light_theme.startsWith('#') && (globalSettings.country_background_color_light_theme.length === 4 || globalSettings.country_background_color_light_theme.length === 7)) ? globalSettings.country_background_color_light_theme : '#ffffff'" @input="globalSettings.country_background_color_light_theme = $event.target.value" class="form-control cursor-pointer" style="max-width: 100px;">
                                    <b-button size="sm" variant="outline-secondary" @click="globalSettings.country_background_color_light_theme = '#00000000'">
                                        {{ __('transparent') || 'Transparent' }}
                                    </b-button>
                                </div>
                            </div>
                            <div class="col-md-6 form-group mb-0">
                                <label>{{ __('country_dark_theme_background') || 'Country Dark Theme Background' }}</label>
                                <div class="d-flex w-100 mt-1" style="gap: 10px; align-items: center;">
                                    <input type="text" v-model="globalSettings.country_background_color_dark_theme" class="form-control">
                                    <input type="color" :value="(globalSettings.country_background_color_dark_theme && globalSettings.country_background_color_dark_theme.startsWith('#') && (globalSettings.country_background_color_dark_theme.length === 4 || globalSettings.country_background_color_dark_theme.length === 7)) ? globalSettings.country_background_color_dark_theme : '#000000'" @input="globalSettings.country_background_color_dark_theme = $event.target.value" class="form-control cursor-pointer" style="max-width: 100px;">
                                    <b-button size="sm" variant="outline-secondary" @click="globalSettings.country_background_color_dark_theme = '#00000000'">
                                        {{ __('transparent') || 'Transparent' }}
                                    </b-button>
                                </div>
                            </div>
        ...
        <!-- Add / Edit -->
        <app-edit-record v-if="create_new || edit_record" :record="edit_record" :globalColors="globalSettings"
    ...
    methods: {
        fetchGlobalColors() {
            axios.get(this.$apiUrl + '/web_settings').then((response) => {
                ...
                this.globalSettings.country_background_color_mode = settings.country_background_color_mode || 'global';
                this.globalSettings.country_background_color_light_theme = settings.country_background_color_light_theme || '';
                this.globalSettings.country_background_color_dark_theme = settings.country_background_color_dark_theme || '';
            });
        },
        saveGlobalColors() {
