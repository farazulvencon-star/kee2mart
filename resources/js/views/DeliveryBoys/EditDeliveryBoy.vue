            ...
            axios.get(this.$apiUrl + '/delivery_boys/edit/' + this.id)
                .then((response) => {
                    ...
                    if (data.status === 1) {
                        ...
                        this.deliveryBoys.driving_license_url = this.record ? this.record.driving_license : "";
                        this.deliveryBoys.national_identity_card = "";
                        this.deliveryBoys.national_identity_card_url = this.record ? this.record.national_identity_card : "";
