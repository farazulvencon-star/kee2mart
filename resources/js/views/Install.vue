<template>
    <div class="auth" :style="{ backgroundImage: 'url('+ $baseUrl + '/images/panel_login_background_img.jpg' + ')' }">
        <div class="login-wrapper">
            <div class="auth-section col-lg-6 mt-5 install-wizard-section">
                <div class="auth-card">
                                            ...
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <button type="button" v-on:click="showAdminPassword = !showAdminPassword" class="btn btn-primary font-bold">
                                                        <img v-if="showAdminPassword" :src="$baseUrl + '/images/icons/show_password.svg'" style="filter: brightness(0) invert(1); width: 20px; height: 20px;" />
...
.install-wizard-section.auth-section {
