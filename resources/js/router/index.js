...
const SelfPickupOrders = () => import("../views/Orders/SelfPickupOrders");
const ViewSelfPickupOrder = () => import("../views/Orders/ViewSelfPickupOrder");
...
const AdditionalCharges = () => import("../views/Setting/AdditionalCharges");
...
const Modules = () => import("../views/Modules/Modules");
...
// Blogs
const BlogCategories = () => import("../views/Blogs/BlogCategories");
const Blogs = () => import("../views/Blogs/Blogs");

// Subscriptions
const Subscriptions = () => import("../views/Subscriptions/Subscriptions");
const SubscriptionsFaqs = () => import("../views/Subscriptions/SubscriptionsFaqs");
...
// Product Requests
const ProductRequests = () => import("../views/Customers/ProductRequests");
...
const PosReports = () => import("../views/Reports/PosReports");
...
const DeliveryBoyReturnRequests = () => import("../views/ReturnRequests/ReturnRequests");
...
const DeliveryBoySalary = () => import("../views/DeliveryBoys/Salary/DeliveryBoySalary");
    ...
    return [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: "self_pickup_orders",
                    name: "SelfPickupOrders",
                    component: SelfPickupOrders,
                    meta: {
                        permission: 'self_pickup_order_list',
                        role: adminRoles,
                        title: 'Self Pickup Orders'
                    },
                },
                {
                    path: "self_pickup_orders/view/:id",
                    name: "ViewSelfPickupOrder",
                    component: ViewSelfPickupOrder,
                    meta: {
                        permission: 'self_pickup_order_list',
                        role: adminRoles,
                        title: 'Self Pickup Order View'
                    },
                },
                {
                    path: "orders/view/:id",
                ...
                {
                    path: "subscriptions_faqs",
                    name: "Subscriptions Faqs",
                    component: SubscriptionsFaqs,
                    meta: {
            ...
            * */
            ...
            children: [
...

             {
                ...
                {
                    path: "return_requests",
                    name: "SellerReturnRequests",
                    component: SellerReturnRequests,
                    meta: {
                        permission: 'order_list',
                        role: sellerRoles,
                        title: 'Return Requests'
...

        {
            ...
            * */
            ...
            children: [
                ...
                {
                    path: "/delivery_boy/notification_panel",
